    ...
    <section className="relative min-h-[100vh] flex flex-col items-center justify-center pt-32 px-4 overflow-hidden z-10">
      ...
      <div className="w-full flex flex-col items-center -translate-y-[30px]">
        ...
        <div className="relative flex justify-center w-full max-w-7xl mx-auto h-[40vh] md:h-[50vh]">
          ...
          {/* ==========================================
              🤖 HƯỚNG DẪN ĐIỀU CHỈNH VỊ TRÍ & KÍCH THƯỚC ROBOT 🤖
              ==========================================
              1. ĐIỀU CHỈNH VỊ TRÍ (Position):
                 - Lên/Xuống: Sửa `-translate-y-[45%]` thành số khác (ví dụ: `-translate-y-[30%]` để robot dịch xuống, `-translate-y-[60%]` để dịch lên).
                 - Trái/Phải: Sửa `-translate-x-1/2` (mặc định là giữa). Đổi thành `-translate-x-[40%]` (dịch phải) hoặc `-translate-x-[60%]` (dịch trái).
              
              2. ĐIỀU CHỈNH KÍCH THƯỚC (Size):
                 - Tăng giảm `w-[120vw]` và `h-[120vw]` (độ lớn dựa theo màn hình).
                 - Giới hạn tối đa: `max-w-[800px]` và `max-h-[800px]`. Tăng số này nếu muốn robot có thể phóng to hơn nữa trên màn hình máy tính.
              ========================================== */}
        ...
        <motion.button
          ...
          className="relative z-30 mt-16 bg-tangerine text-white font-black text-xl md:text-2xl px-12 py-5 rounded-2xl shadow-[0_8px_0_#b36600] active:translate-y-2 active:shadow-none hover:brightness-110 transition-all uppercase tracking-wide border-4 border-[#b36600]"
        >
          Khởi Hành Ngay
        </motion.button>
